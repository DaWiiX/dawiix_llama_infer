...
TEST(test_swiglu_cu, swiglu_nostream)
{
    ...
    kernel::get_swiglu_kernel(base::DeviceType::DeviceCUDA)(in_cu, wei_cu, out_cu,
                                                             nullptr);
    out_cu.to_cpu();

    kernel::get_swiglu_kernel(base::DeviceType::DeviceCPU)(in_cpu, wei_cpu, out_cpu,
                                                            nullptr);
...
TEST(test_swiglu_cu, swiglu_stream)
{
    ...
    kernel::get_swiglu_kernel(base::DeviceType::DeviceCUDA)(in_cu, wei_cu, out_cu, stream);
    out_cu.to_cpu();
