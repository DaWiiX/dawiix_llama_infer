...
namespace kernel
{
    ...
    )
    {
        ...
        for (int32_t h = 0; h < head_num; ++h)
        {
            ...
            tensor::Tensor query_mat(base::DataType::DataTypeFp32, head_size, false, nullptr,
                                     query_head_addr);
            ...
            for (int32_t t = 0; t <= pos; t++)
            {
                ...
                tensor::Tensor key_mat(base::DataType::DataTypeFp32, 1, head_size, false, nullptr,
                                       const_cast<float *>(key_head_addr));

                tensor::Tensor score_mat(base::DataType::DataTypeFp32, 1, false, nullptr,
                                         score_head_addr + t);
            ...
            tensor::Tensor score_head_tensor(base::DataType::DataTypeFp32, pos + 1, false, nullptr,
                                             score_head_addr);
            ...
            tensor::Tensor output_tensor(base::DataType::DataTypeFp32, head_size, false, nullptr,
                                         output_head_ptr);
            ...
            tensor::Tensor value_tensor(base::DataType::DataTypeFp32, head_size, false, nullptr,
                                        value_head_addr);
